...
- **Spot purchase capable** — available for non-licensed services under $25,000 immediately
- **Documentation** — itemized invoicing, photo documentation, and agency-format reporting available
...
|---|---|---|
| Texas HUB — VetHUB Program | Texas Comptroller of Public Accounts | **Active · 6/9/2026–6/9/2030** |
| SDVOSB — Service-Disabled Veteran-Owned | U.S. Dept. of Veterans Affairs | **Verified** |
| SAM.gov | U.S. GSA | **Active** |
| B2G Vendor ID | Texas SmartBuy / CMBL | **21829543** |
| Texas-Licensed Trades | TDLR / TSBPE | **Current** |
| Commercial General Liability | — | **Active — $1M+ per occurrence** |
...
## NIGP Codes (State of Texas / CMBL)

- **91000** — Building Maintenance, Installation and Repair Services
- **91082** — Wiring and Other Electrical Maintenance and Repair
- **91141** — C.I.P., Landscaping
- **91450** — HVAC (Heating, Ventilating, and Air Conditioning)
- **98852** — General Grounds Maintenance
- **910-39** — Janitorial / Custodial Services
- **968-94** — Pressure Washing Services
- **910-54** — Painting and Wall Covering
- **910-25** — Flooring Maintenance and Repair
